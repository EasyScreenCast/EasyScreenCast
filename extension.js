...
const EasyScreenCast_Indicator = new Lang.Class({
     ...
     * @param focus
     */
    refreshIndicator(param1, param2, focus) {
        Lib.TalkativeLog(
